  ...
  return (
    <div className="mm-page" style={{ minHeight: '100vh', background: 'var(--mm-ink)', color: 'var(--mm-cream)', fontFamily: 'var(--mm-body)' }}>
      <style>{`
        ...
        @media (max-width: 600px) { .mm-hero-inner { padding:20px 24px 32px !important; overflow:hidden !important; } .mm-chrome { flex-direction:column !important; } .mm-coords { text-align:left !important; } .mm-hero-bottom { width:100% !important; } .mm-hero-bottom > div, .mm-hero-bottom aside { width:100% !important; min-width:0 !important; max-width:100% !important; } .mm-headline { font-size:clamp(46px, 13.4vw, 52px) !important; max-width:100% !important; overflow-wrap:normal !important; letter-spacing:-0.04em !important; } .mm-hero-bottom p { max-width:100% !important; font-size:16px !important; } .mm-hero-bottom .mm-btn { max-width:100% !important; } .mm-count-row { width:100% !important; flex-wrap:wrap !important; gap:14px 18px !important; } .mm-count-n { font-size:40px !important; } .mm-eyebrow-mobile-wrap { flex-wrap:wrap !important; } .mm-training-title { font-size:clamp(46px, 14vw, 56px) !important; } .mm-training-label { width:100% !important; justify-content:flex-start !important; } .mm-past-winners-section { padding:30px 18px 32px !important; } .mm-past-winners-grid { grid-template-columns:1fr !important; gap:30px !important; } .mm-past-winners-title { font-size:clamp(44px, 13vw, 50px) !important; letter-spacing:-0.04em !important; } .mm-past-winners-stats { grid-template-columns:1fr !important; max-width:100% !important; } .mm-past-winner-row { grid-template-columns:54px minmax(0, 1fr) !important; gap:12px !important; } .mm-past-winner-points { grid-column:2 !important; text-align:left !important; margin-top:-6px !important; } }
      `}</style>
