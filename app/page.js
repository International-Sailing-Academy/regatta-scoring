    ...
    <div style={{ 
      ...
      <div style={{ textAlign: 'center' }}>
        <div style={{ color: 'var(--mm-sun)', marginBottom: '20px' }}>
          <img src="/logo-icon-white-padded.png" alt="" style={{ height: '40px', width: 'auto', objectFit: 'contain' }} />
        </div>
  ...
  return (
    <div className="mm-page" style={{ minHeight: '100vh', background: 'var(--mm-ink)', color: 'var(--mm-cream)', fontFamily: 'var(--mm-body)' }}>
      <style>{`
        ...
        .mm-hero-date-card { display:inline-flex; align-items:center; gap:14px; margin-top:22px; padding:11px 15px; background:rgba(244,168,42,.94); color:var(--mm-ink); border:1px solid rgba(255,255,255,.22); box-shadow:0 14px 36px rgba(0,0,0,.20); font-family:var(--mm-mono); font-size:clamp(13px, 1.25vw, 17px); font-weight:900; letter-spacing:.16em; text-transform:uppercase; }
        ...
        .mm-past-winners-frame { left:-26px !important; top:20px !important; bottom:20px !important; width:48% !important; border-color:rgba(244,168,42,0.30) !important; }
        .mm-past-winners-grid { padding-left:clamp(18px, 2.2vw, 30px) !important; box-sizing:border-box !important; }
        .mm-past-winner-row { grid-template-columns:74px minmax(0, 1fr) 112px !important; }
        .mm-past-winner-points { justify-self:center !important; min-width:96px !important; text-align:center !important; }
        ...
        @media (max-width: 600px) { .mm-hero-inner { padding:20px 24px 32px !important; overflow:hidden !important; } .mm-chrome { flex-direction:column !important; } .mm-coords { text-align:left !important; } .mm-hero-bottom { width:100% !important; } .mm-hero-bottom > div, .mm-hero-bottom aside { width:100% !important; min-width:0 !important; max-width:100% !important; } .mm-headline { font-size:clamp(46px, 13.4vw, 52px) !important; max-width:100% !important; overflow-wrap:normal !important; letter-spacing:-0.04em !important; } .mm-hero-date-card { width:auto !important; max-width:100% !important; box-sizing:border-box !important; justify-content:center !important; text-align:center !important; font-size:12px !important; letter-spacing:.10em !important; padding:10px 12px !important; margin-top:16px !important; } .mm-hero-bottom p { max-width:100% !important; font-size:16px !important; } .mm-hero-bottom .mm-btn { max-width:100% !important; } .mm-count-row { width:100% !important; flex-wrap:wrap !important; gap:14px 18px !important; } .mm-count-n { font-size:40px !important; } .mm-eyebrow-mobile-wrap { flex-wrap:wrap !important; } .mm-training-title { font-size:clamp(46px, 14vw, 56px) !important; } .mm-training-label { width:100% !important; box-sizing:border-box !important; justify-content:flex-start !important; } .mm-final-banner { padding:0 16px !important; } .mm-final-banner > div { grid-template-columns:1fr !important; min-width:0 !important; padding:28px 20px !important; gap:20px !important; } .mm-final-banner > div > div { min-width:0 !important; max-width:100% !important; justify-self:stretch !important; } .mm-final-banner-title { font-size:clamp(42px, 12vw, 50px) !important; line-height:0.9 !important; letter-spacing:-0.045em !important; overflow-wrap:anywhere !important; } .mm-final-banner p { max-width:100% !important; font-size:15px !important; line-height:1.45 !important; overflow-wrap:anywhere !important; } .mm-final-banner a { max-width:100% !important; box-sizing:border-box !important; white-space:normal !important; text-align:center !important; justify-content:center !important; } .mm-past-winners-section { padding:28px 16px 42px !important; margin-bottom:44px !important; overflow:visible !important; } .mm-past-winners-grid { grid-template-columns:1fr !important; gap:28px !important; padding-left:0 !important; } .mm-past-winners-title { font-size:clamp(42px, 12.5vw, 50px) !important; letter-spacing:-0.04em !important; } .mm-past-winners-stats { grid-template-columns:repeat(3, minmax(0, 1fr)) !important; max-width:100% !important; } .mm-past-winner-row { grid-template-columns:58px minmax(0, 1fr) !important; gap:14px !important; align-items:start !important; padding:16px 0 !important; } .mm-past-winner-rank { font-size:28px !important; padding-top:2px !important; white-space:nowrap !important; } .mm-past-winner-name { font-size:clamp(24px, 7vw, 30px) !important; line-height:1.02 !important; overflow-wrap:anywhere !important; } .mm-past-winner-meta { font-size:9px !important; line-height:1.35 !important; letter-spacing:0.12em !important; overflow-wrap:anywhere !important; } .mm-past-winners-frame { left:-14px !important; right:-14px !important; width:auto !important; transform:skewX(-4deg) !important; } .mm-past-winner-points { grid-column:2 !important; justify-self:start !important; min-width:0 !important; text-align:left !important; margin-top:0 !important; display:flex !important; align-items:baseline !important; gap:8px !important; } .mm-past-winner-points > div:first-child { font-size:24px !important; } }
      `}</style>
        ...
        <div className="mm-hero-inner" style={{ position: 'relative', zIndex: 3, minHeight: '100vh', padding: '24px 48px 48px', display: 'flex', flexDirection: 'column' }}>
          <header style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '32px' }}>
            <a href="/" style={{ display: 'flex', alignItems: 'center', gap: '14px', color: 'var(--mm-cream)', textDecoration: 'none' }}>
              <img src="/logo-icon-white-padded.png" alt="ISA" style={{ height: '40px', width: 'auto', objectFit: 'contain' }} />
          ...
          <div className="mm-hero-bottom" style={{ marginTop: 'auto', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', gap: '64px', paddingTop: '80px' }}>
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div className="mm-hero-date-card">March 11–13, 2027</div>
              <p style={{ maxWidth: '540px', marginTop: '18px', fontSize: '17px', lineHeight: 1.55, color: 'rgba(242,237,224,0.82)', fontFamily: 'var(--mm-body)', fontWeight: 300 }}>
                {copy.lede}
              </p>
            ...
            <div style={{ animation: 'fadeInUp 0.5s ease-out' }}>
              ...
              <section id="pre-regatta-training" style={{ scrollMarginTop: '24px', marginBottom: '60px' }}>
                <div style={{ marginBottom: '28px' }}>
                  ...
                  <div className="mm-training-label mm-hero-mono" style={{ display: 'inline-flex', marginTop: '28px', background: 'var(--mm-sun)', color: 'var(--mm-ink)', padding: '13px 16px', fontSize: '12px', fontWeight: 900, letterSpacing: '0.28em', textTransform: 'uppercase' }}>Before Midwinters</div>
                </div>
              ...
              <section id="past-winners" className="mm-past-winners-section" style={{ scrollMarginTop: '24px', marginBottom: '60px', position: 'relative', overflow: 'hidden', background: 'var(--mm-ink-2)', border: '1px solid rgba(244,168,42,0.26)', borderRadius: '4px', padding: '34px clamp(22px, 4vw, 44px)' }}>
                ...
                <div className="mm-past-winners-frame" style={{ position: 'absolute', left: '24px', top: '24px', bottom: '24px', width: '38%', border: '1px solid rgba(244,168,42,0.34)', borderRight: 'none', transform: 'skewX(-6deg)', pointerEvents: 'none' }} />
                  ...
                  <div>
                    {archived2026Results.map((sailor, index) => (
                      <div key={`${sailor.name}-${index}`} className="mm-past-winner-row" style={{ display: 'grid', gridTemplateColumns: '74px 1fr auto', gap: '18px', alignItems: 'center', padding: '18px 0', borderTop: index === 0 ? '1px solid rgba(244,168,42,0.38)' : '1px solid rgba(242,237,224,0.14)' }}>
                        <div className="mm-past-winner-rank" style={{ fontFamily: 'var(--mm-display)', fontWeight: 900, fontSize: '42px', color: index === 0 ? 'var(--mm-sun)' : 'rgba(242,237,224,0.76)', lineHeight: 1 }}>{index + 1}{index === 0 ? 'st' : index === 1 ? 'nd' : 'rd'}</div>
                        <div>
                          <div className="mm-past-winner-name" style={{ fontFamily: 'var(--mm-display)', fontWeight: 900, fontSize: 'clamp(24px, 3.2vw, 42px)', lineHeight: 0.98, textTransform: 'uppercase', color: index === 0 ? 'var(--mm-sun)' : 'var(--mm-cream)' }}>{sailor.name}</div>
                          <div className="mm-hero-mono mm-past-winner-meta" style={{ marginTop: '8px', fontSize: '10px', letterSpacing: '0.18em', color: 'rgba(242,237,224,0.48)' }}>{sailor.country || '—'} · {sailor.boatClass || 'ILCA 6'} · Sail #{sailor.sailNumber || '—'}</div>
                        </div>
              ...
              <section style={{ marginBottom: '60px' }}>
                <h2 style={{ fontSize: '32px', marginBottom: '30px', display: 'flex', alignItems: 'center', gap: '15px' }}>
                  <img src="/logo-icon-white-padded.png" alt="" style={{ height: '24px', width: 'auto', objectFit: 'contain', verticalAlign: 'middle' }} />
                  Classes & Awards
                </h2>
                <div style={{ background: 'rgba(255,255,255,0.05)', borderRadius: '16px', padding: '30px', border: '1px solid rgba(255,255,255,0.1)' }}>
      ...
      <footer style={{ 
        ...
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          <div style={{ marginBottom: '30px', display: 'flex', justifyContent: 'center' }}>
            <img src="/logo-horizontal-white-padded.png" alt="International Sailing Academy" style={{ maxWidth: '320px', height: 'auto' }} />
          </div>
