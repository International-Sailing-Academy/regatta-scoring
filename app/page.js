  ...
  return (
    <div className="mm-page" style={{ minHeight: '100vh', background: 'var(--mm-ink)', color: 'var(--mm-cream)', fontFamily: 'var(--mm-body)' }}>
      <style>{`
        ...
        .mm-hero-date-card { display:inline-flex; align-items:center; gap:14px; margin-top:28px; padding:14px 18px; background:rgba(244,168,42,.94); color:var(--mm-ink); border:1px solid rgba(255,255,255,.22); box-shadow:0 18px 50px rgba(0,0,0,.22); font-family:var(--mm-mono); font-size:clamp(14px, 1.5vw, 20px); font-weight:900; letter-spacing:.18em; text-transform:uppercase; }
        ...
        <div className="mm-hero-inner" style={{ position: 'relative', zIndex: 3, minHeight: '100vh', padding: '24px 48px 48px', display: 'flex', flexDirection: 'column' }}>
          ...
          <div className="mm-hero-bottom" style={{ marginTop: 'auto', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', gap: '64px', paddingTop: '80px' }}>
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <p style={{ maxWidth: '540px', marginTop: '24px', fontSize: '17px', lineHeight: 1.55, color: 'rgba(242,237,224,0.82)', fontFamily: 'var(--mm-body)', fontWeight: 300 }}>
                {copy.lede}
              </p>
