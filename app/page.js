  ...
  return (
    <div className="mm-page" style={{ minHeight: '100vh', background: 'var(--mm-ink)', color: 'var(--mm-cream)', fontFamily: 'var(--mm-body)' }}>
      <style>{`
        ...
        .mm-past-winners-frame { left:-18px !important; top:20px !important; bottom:20px !important; width:46% !important; border-color:rgba(244,168,42,0.30) !important; }
